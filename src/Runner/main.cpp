...
//   sf::RectangleShape rectField(sf::Vector2f((cellSize * SIZE) - 1, (cellSize * SIZE) - 1));
...
//   int selectX = 3;
//   int selectY = 2;
//   oneCell.move(cellSize * selectX + offsetGameFieldX, cellSize * selectY + offsetGameFieldY);
...
//     sf::Vector2f pointInActive = invActiveTr.transformPoint(pixelPos.x, pixelPos.y);

//     // std::cout << pixelPos.x << std::endl;
//     // std::cout << pointInActive.x << ", " << pointInActive.y << std::endl;

//     if (pointInActive.x < 0) pointInActive.x = 0;
//     if (pointInActive.x > ACTIVE_RECT_WIDTH - 1) pointInActive.x = ACTIVE_RECT_WIDTH - 1;

//     if (pointInActive.y < 0) pointInActive.y = 0;
//     if (pointInActive.y > ACTIVE_RECT_HEIGHT - 1) pointInActive.y = ACTIVE_RECT_HEIGHT - 1;
